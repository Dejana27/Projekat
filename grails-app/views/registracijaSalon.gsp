...
<head>
    ...
    <title>Registracija partneri</title>
                        ...
                        <div class="card mb-3 registrationForm">
                            ...
                            <div class="card-body">
                                ...
                                <form class="row registration_row needs-validation" novalidate>
                                    ...
                                    <div class="col-12" id="cityCss">
                                        <label for="city" class="form-label">Grad</label>
                                        <select id="city" class="form_control"></select>
                                    </div>
                                    <div class="col-12">
                                        <label for="street" class="form-label">Ulica</label>
                                        <select class="form-control" id="street">
                                            <option selected="selected">19. Decembra</option>
                                            <option>4. Jula</option>
                                            <option>Miloša Obilića</option>
                                        </select>
                                    </div>
                                    <div class="col-12">
                                        <label for="workDays" class="form-label">Radni dani</label>
                                        <input type="text" name="days" class="form-control" id="workDays" required>
                                        <div class="invalid-feedback">Molimo Vas, ukucajte radne dane</div>
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <div class="col-12" id="typeCss">
                                        <label for="type" class="form-label">Tip salona</label>
                                        <select id="type" class="form_control"></select>
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="acceptTerms">Slažem se i prihvatam <a href="#">uslove</a></label>
                                    ...
                                    <div class="col-12">
                                        <p class="small mb-0">Već imate nalog? <g:link controller="main" action="index">Ulogujte se</g:link></p>
                                    </div>
...
<asset:javascript src="registracijaSalona.js"/>

<script>
    let createSalonUrl = "${g.createLink(controller: 'register', action:'createSalonUser')}";
    let displayAllCities = "${g.createLink(controller: 'grad', action: 'createCities')}";
    let displayAllSalons = "${g.createLink(controller: 'salon', action: 'displaySalon')}";
    let checkEmailAvailabilityUrl = "${g.createLink(controller: "register", action: "checkEmailAvailability")}"
</script>
</body>
