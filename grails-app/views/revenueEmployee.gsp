...
<main id="main">
    <div class="row">
        <h4>Zarada - ${ime} ${prezime}</h4>
        <div>
        <select id="selectYear"  style="margin: 10px;">
            <option value="2023">2023</option>
            <option value="2024"  selected="2024">2024</option>
            <option value="2025">2025</option>
            <option value="2026">2025</option>
        </select>
        <select id="selectMonth"  style="maring: 10px;">
...
<script>
    let getRevenueForEachMonthUrl = "${g.createLink(controller: "zaposleni", action: "getRevenueForEachMonth")}";
</script>
<asset:javascript src="getRevenue.js"/>
